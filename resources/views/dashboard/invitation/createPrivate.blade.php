        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.invitation.storePrivate') }}" method="POST"
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-4 mb-3">
                                        <label class="form-label" for="max_date">تاريخ الحد الأقصى</label>
                                        <select name="max_date" id="max_date" class="form-control @error('max_date') is-invalid @enderror">
                                            <option value="">اختر تاريخ الحد الأقصى</option> <!-- Placeholder option -->
                                            <option value="day" {{ old('max_date') == 'day' ? 'selected' : '' }}>يوم</option>
                                            <option value="month" {{ old('max_date') == 'month' ? 'selected' : '' }}>شهر</option>
                                            <option value="year" {{ old('max_date') == 'year' ? 'selected' : '' }}>سنة</option>
                                        </select>
                                        @error('max_date')
