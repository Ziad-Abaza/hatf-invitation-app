...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">لوحة التحكم/</span> الادمن / تعديل </h4>
                        ...
                        <form action="{{ route('dashboard.admin.update', $admin->id) }}" method="POST"
                            ...
                            <div class="row justify-content-between">
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="basic-default-fullname">الأسم</label>
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="basic-default-phone">رقم الهاتف</label>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="password" name="password"
                                        ...
                                        id="basic-default-password" placeholder="كلمة المرور" />
                                    @error('password')
                                        <div
                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="basic-default-address">العنوان</label>
                                    <input type="text" name="address" value="{{ old('address', $admin->address) }}"
                                        class="form-control @error('address') is-invalid @enderror"
                                        id="basic-default-address" placeholder="العنوان" />
                                    @error('address')
                                        <div
                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                            {{ $message }}
