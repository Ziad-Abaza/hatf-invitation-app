...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">لوحة التحكم /</span> القاعات / إنشاء</h4>
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.hall.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <textarea name="desc" class="form-control @error('desc') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    @error('desc')
                                        <div
                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                            {{ $message }}
