...
class UserPaymentController extends Controller
{
    ...
    /**
     * دالة الدفع الوهمي (للاختبار فقط)
     * هذه الدالة تُنشئ استجابة دفع ناجحة بدون معالجة دفع حقيقية
     */
    public function testPayment(Request $request)
    {
        Log::info("================= Start Test Payment (Fake Payment) =================");

        // تسجيل أن هذا الدفع هو اختباري
        ...
        try {
            ...
            // إرجاع استجابة مشابهة للدفع الحقيقي الناجح
